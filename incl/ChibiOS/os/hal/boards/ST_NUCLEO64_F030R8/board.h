...
#define GPIOA_SPI_NSCS              4U
#define GPIOA_SPI_SCLK              5U
#define GPIOA_ARD_D13               5U
#define GPIOA_SPI_SDO               6U
#define GPIOA_SPI_SDI               7U
#define GPIOA_ARD_D7                8U
#define GPIOA_ARD_D8                9U
#define GPIOA_PWM_IN                10U
...
#define GPIOB_LED_STATUS            6U
#define GPIOB_PIN7                  7U
#define GPIOB_ARD_D15               8U
#define GPIOB_ARD_D14               9U
#define GPIOB_INHA                 10U
#define GPIOB_INLA                 11U
#define GPIOB_INHB                 12U
#define GPIOB_INLB                 13U
#define GPIOB_INHC                 14U
#define GPIOB_INLC                 15U
...
#define LINE_SPI_NSCS               PAL_LINE(GPIOA, 4U)
#define LINE_SPI_SCLK               PAL_LINE(GPIOA, 5U)
#define LINE_ARD_D13                PAL_LINE(GPIOA, 5U)
#define LINE_ARD_SDO                PAL_LINE(GPIOA, 6U)
#define LINE_ARD_SDI                PAL_LINE(GPIOA, 7U)
 ...
 * GPIOA setup:
 *
 * PA0  - ARD_A0 ADC1_IN0           (input pulldown).
 * PA1  - ARD_A1 ADC1_IN1           (input pulldowm).
 * PA2  - ARD_D1 USART2_TX          (input pulldowm).
 * PA3  - ARD_D0 USART2_RX          (input pullup).
 * PA4  - ARD_A2 ADC1_IN4           (output pullup).
 * PA5  - LED_GREEN ARD_D13         (output pullup).
 * PA6  - ARD_D12                   (output pullup).
 * PA7  - ARD_D11                   (output pullup).
 * PA8  - ARD_D7                    (not used).
 * PA9  - ARD_D8                    (not used).
 * PA10 - ARD_D2                    (input pulldown).
 * PA11 - PIN11                     (not used).
 * PA12 - PIN12                     (not used).
...
#define VAL_GPIOA_MODER             (PIN_MODE_ANALOG(GPIOA_ARD_A0) |         \
                                     ...
                                     PIN_MODE_ALTERNATE(GPIOA_ARD_A2) |         \
                                     PIN_MODE_ALTERNATE(GPIOA_SPI_SCLK) |     \
                                     PIN_MODE_ALTERNATE(GPIOA_SPI_SDO) |        \
                                     PIN_MODE_ALTERNATE(GPIOA_SPI_SDI) |        \
                                     PIN_MODE_INPUT(GPIOA_ARD_D7) |         \
                                     PIN_MODE_INPUT(GPIOA_ARD_D8) |         \
                                     PIN_MODE_INPUT(GPIOA_PWM_IN) |         \
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_ARD_A0) |     \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOA_SPI_SCLK) |  \
                                     PIN_OTYPE_PUSHPULL(GPIOA_SPI_SDO) |    \
                                     PIN_OTYPE_PUSHPULL(GPIOA_SPI_SDI) |    \
                                     PIN_OTYPE_PUSHPULL(GPIOA_ARD_D7) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOA_ARD_D8) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PWM_IN) |     \
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_HIGH(GPIOA_ARD_A0) |        \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOA_SPI_SCLK) |      \
                                     PIN_OSPEED_HIGH(GPIOA_SPI_SDO) |       \
                                     PIN_OSPEED_HIGH(GPIOA_SPI_SDI) |       \
                                     PIN_OSPEED_HIGH(GPIOA_ARD_D7) |        \
                                     PIN_OSPEED_HIGH(GPIOA_ARD_D8) |        \
                                     PIN_OSPEED_HIGH(GPIOA_PWM_IN) |        \
                                     PIN_OSPEED_HIGH(GPIOA_PIN11) |         \
                                     PIN_OSPEED_HIGH(GPIOA_PIN12) |         \
                                     PIN_OSPEED_HIGH(GPIOA_SWDIO) |         \
                                     PIN_OSPEED_HIGH(GPIOA_SWCLK) |         \
                                     PIN_OSPEED_HIGH(GPIOA_PIN15))
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_PULLDOWN(GPIOA_ARD_A0) |       \
                                     PIN_PUPDR_PULLDOWN(GPIOA_ARD_A1) |       \
                                     PIN_PUPDR_PULLDOWN(GPIOA_ARD_D1) |     \
                                     PIN_PUPDR_PULLUP(GPIOA_ARD_D0) |     \
                                     PIN_PUPDR_PULLUP(GPIOA_ARD_A2) |       \
                                     PIN_PUPDR_PULLUP(GPIOA_SPI_SCLK) |  \
                                     PIN_PUPDR_PULLUP(GPIOA_SPI_SDO) |      \
                                     PIN_PUPDR_PULLUP(GPIOA_SPI_SDI) |      \
                                     PIN_PUPDR_PULLUP(GPIOA_ARD_D7) |       \
                                     PIN_PUPDR_PULLUP(GPIOA_ARD_D8) |       \
                                     PIN_PUPDR_PULLDOWN(GPIOA_PWM_IN) |       \
...
#define VAL_GPIOA_ODR               (PIN_ODR_HIGH(GPIOA_ARD_A0) |           \
                                     ...
                                     PIN_ODR_LOW(GPIOA_SPI_SCLK) |         \
                                     PIN_ODR_HIGH(GPIOA_SPI_SDO) |          \
                                     PIN_ODR_HIGH(GPIOA_SPI_SDI) |          \
                                     PIN_ODR_HIGH(GPIOA_ARD_D7) |           \
                                     PIN_ODR_HIGH(GPIOA_ARD_D8) |           \
                                     PIN_ODR_HIGH(GPIOA_PWM_IN) |           \
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_ARD_A0, 0U) |        \
                                     ...
                                     PIN_AFIO_AF(GPIOA_SPI_SCLK, 0U) |     \
                                     PIN_AFIO_AF(GPIOA_SPI_SDO, 0U) |       \
                                     PIN_AFIO_AF(GPIOA_SPI_SDI, 0U))
#define VAL_GPIOA_AFRH              (PIN_AFIO_AF(GPIOA_ARD_D7, 0U) |        \
                                     PIN_AFIO_AF(GPIOA_ARD_D8, 0U) |        \
                                     PIN_AFIO_AF(GPIOA_PWM_IN, 0U) |        \
 ...
 */
#define VAL_GPIOB_MODER             (PIN_MODE_OUTPUT(GPIOB_ARD_A3) |         \
                                     ...
                                     PIN_MODE_OUTPUT(GPIOB_INHA) |         \
                                     PIN_MODE_OUTPUT(GPIOB_INLA) |          \
                                     PIN_MODE_OUTPUT(GPIOB_INHB) |          \
                                     PIN_MODE_OUTPUT(GPIOB_INLB) |          \
                                     PIN_MODE_OUTPUT(GPIOB_INHC) |          \
                                     PIN_MODE_OUTPUT(GPIOB_INLC))
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_ARD_A3) |     \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOB_INHA) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOB_INLA) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOB_INHB) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOB_INLB) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOB_INHC) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOB_INLC))
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_LOW(GPIOB_ARD_A3) |        \
                                     PIN_OSPEED_LOW(GPIOB_PIN1) |          \
                                     PIN_OSPEED_HIGH(GPIOB_PIN2) |          \
                                     PIN_OSPEED_HIGH(GPIOB_SWO) |           \
                                     PIN_OSPEED_HIGH(GPIOB_ARD_D5) |        \
                                     PIN_OSPEED_HIGH(GPIOB_ARD_D4) |        \
                                     PIN_OSPEED_LOW(GPIOB_LED_STATUS) |       \
                                     PIN_OSPEED_HIGH(GPIOB_PIN7) |          \
                                     PIN_OSPEED_HIGH(GPIOB_ARD_D15) |       \
                                     PIN_OSPEED_HIGH(GPIOB_ARD_D14) |       \
                                     PIN_OSPEED_HIGH(GPIOB_INHA) |        \
                                     PIN_OSPEED_HIGH(GPIOB_INLA) |         \
                                     PIN_OSPEED_HIGH(GPIOB_INHB) |         \
                                     PIN_OSPEED_HIGH(GPIOB_INLB) |         \
                                     PIN_OSPEED_HIGH(GPIOB_INHC) |         \
                                     PIN_OSPEED_HIGH(GPIOB_INLC))
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_PULLDOWN(GPIOB_ARD_A3) |       \
                                     PIN_PUPDR_PULLDOWN(GPIOB_PIN1) |         \
                                     PIN_PUPDR_PULLUP(GPIOB_PIN2) |         \
                                     PIN_PUPDR_PULLUP(GPIOB_SWO) |          \
                                     PIN_PUPDR_PULLUP(GPIOB_ARD_D5) |       \
                                     PIN_PUPDR_PULLUP(GPIOB_ARD_D4) |       \
                                     PIN_PUPDR_PULLDOWN(GPIOB_LED_STATUS) |      \
                                     PIN_PUPDR_PULLUP(GPIOB_PIN7) |         \
                                     PIN_PUPDR_PULLUP(GPIOB_ARD_D15) |      \
                                     PIN_PUPDR_PULLUP(GPIOB_ARD_D14) |      \
                                     PIN_PUPDR_PULLDOWN(GPIOB_INHA) |       \
                                     PIN_PUPDR_PULLDOWN(GPIOB_INLA) |        \
                                     PIN_PUPDR_PULLDOWN(GPIOB_INHB) |        \
                                     PIN_PUPDR_PULLDOWN(GPIOB_INLB) |        \
                                     PIN_PUPDR_PULLDOWN(GPIOB_INHC) |        \
                                     PIN_PUPDR_PULLDOWN(GPIOB_INLC))
#define VAL_GPIOB_ODR               (PIN_ODR_HIGH(GPIOB_ARD_A3) |           \
                                     ...
                                     PIN_ODR_HIGH(GPIOB_INHA) |           \
                                     PIN_ODR_HIGH(GPIOB_INLA) |            \
                                     PIN_ODR_HIGH(GPIOB_INHB) |            \
                                     PIN_ODR_HIGH(GPIOB_INLB) |            \
                                     PIN_ODR_HIGH(GPIOB_INHC) |            \
                                     PIN_ODR_HIGH(GPIOB_INLC))
#define VAL_GPIOB_AFRL              (PIN_AFIO_AF(GPIOB_ARD_A3, 0U) |        \
                                     ...
                                     PIN_AFIO_AF(GPIOB_LED_STATUS, 0U) |       \
                                     PIN_AFIO_AF(GPIOB_PIN7, 0U))
#define VAL_GPIOB_AFRH              (PIN_AFIO_AF(GPIOB_ARD_D15, 0U) |       \
                                     PIN_AFIO_AF(GPIOB_ARD_D14, 0U) |       \
                                     PIN_AFIO_AF(GPIOB_INHA, 0U) |        \
                                     PIN_AFIO_AF(GPIOB_INLA, 0U) |         \
                                     PIN_AFIO_AF(GPIOB_INHB, 0U) |         \
                                     PIN_AFIO_AF(GPIOB_INLB, 0U) |         \
                                     PIN_AFIO_AF(GPIOB_INHC, 0U) |         \
                                     PIN_AFIO_AF(GPIOB_INLC, 0U))
